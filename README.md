...
В программе имеется счетчик, который по достижении критического значения закончить обработку файла. Чем больше значение в ниеприведенном #define, тем больше допущений сделает интерпретатор для проверки более сложных неочевидных конструкций.
